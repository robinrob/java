...
/**
 * This class creates a panel to display product information, the quantity of that product
 * contained in the basket, and adding and removal buttons for adding/removing
 * the product from the shopping basket.
 * 
 * @author Robin Smith
 * @version 2009.01.18
 */
