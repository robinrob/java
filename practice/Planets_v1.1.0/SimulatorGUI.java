...
//-----------------------------------80 characters------------------------------    
    ...
    public void displayCycle()
    {
        ...
        canvas.setForegroundColor(Color.black);
        canvas.drawString("Simulator cycle number:", 150, 700);
    ...
    /**
     * Displays the current mass of the simulator's central body on the 
     * canvas.
     */
    public void displayCentralMass()
    {
        ...
        if (sim.getCentralMass() != null){
            canvas.drawString(""+sim.getCentralMass().getMass(), 300, 760);
        }
    }
    
    /**
     * Displays the current mass of the simulator's secondary bodys on
     * the canvas.
     */
...
//-----------------------------------80 characters------------------------------  
    ...
    public void drawBody(Body body) {
        canvas.setForegroundColor(body.getColour());
        canvas.fillCircle((int) body.getXPos(), (int) body.getYPos(), 
                          body.getDiameter());
    }
    /**
     * Erases a body from the canvas.
     * @param body Body to be erased
     */
    public void eraseBody(Body body) {
        canvas.eraseCircle((int) body.getXPos(), (int) body.getYPos(), 
                           body.getDiameter());
    }
