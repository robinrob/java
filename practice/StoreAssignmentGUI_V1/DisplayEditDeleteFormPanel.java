...
/**
 * This class creates a display to display information contained in a an array of strings.
 * It is used for displaying addresses, customer informtion and card details.  It contains
 * an edit button which causes an instance of this form of JPanel to create an
 * InputForm on top of itself, so that the user can edit their details and submit them.
 * 
 * @author Robin Smith
 * @version 2009.01.18
 */
