...
public class CheckoutModule extends Module
{
    ...
    {
        Order order = new Order(store.getCurrentUser().getUsername(), store.getCurrentUser().getAddressType("delivery"),
                                store.getCurrentUser().getAddressType("billing"), store.getBasket(), store.getCurrentUser().getPostage(), store.getBasket().getTotal());
